...
local icepercent = dark_addon.settings.fetch('dr_example_icefort.spin')
local antimagic = dark_addon.settings.fetch('dr_example_antimagic.check')
local antimagicpercent = dark_addon.settings.fetch('dr_example_antimagic.spin')
...
local deathstrike = dark_addon.settings.fetch('dr_example_ds.spin')
...
local deathstrikeaoe = dark_addon.settings.fetch('dr_example_dsaoe.spin')
...
local function interface()
   ...
   --   { key = 'multit', type = 'checkbox', text = 'Multitarget', desc = 'Use Multitarget Rotation in Multitarget' },
      ...
      { key = 'vamp', type = 'checkspin', text = 'Vampiric Blood HP%', desc = 'What % you will be using Vampiric Blood at', min = 10, max = 100, step = 5 },
      { type = 'rule' },

      { type = 'text', text = 'Utility' },
      { key = 'grip', type = 'checkbox', text = 'Death Grip', desc = 'Grip your current target, holding down Control' },
      { key = 'ds', type = 'checkspin', text = 'Death Strike ST', desc = 'What %HP you will use Death Strike Single Target', min = 10, max = 100, step = 5 },
      { key = 'dsaoe', type = 'checkspin', text = 'Death Strike MT', desc = 'What %HP you will use Death Strike MutliTarget', min = 10, max = 100, step = 5 },
