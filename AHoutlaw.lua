...
local vialpercent = dark_addon.settings.fetch('dr_example_vial.spin', 55)
...
local function interface()
   local example = {
    ...
    show = false,
    template = {
      { type = 'header', text = '               Outlaw Settings' },
      { type = 'text', text = 'Oi Pirate! Shank and Shoot your enemies with this wonderful Rotation!' },
      { type = 'rule' },   
      { type = 'text', text = 'Class Specific' },
      { key = 'cds', type = 'checkbox', text = 'Cooldowns', desc = 'Use Adrenaline Rush in Combat' },
      ...
      { key = 'vial', type = 'checkspin', text = 'Vial of Crimson HP%', desc = 'What % you will be using Vial of Crimson at', default_spin = 55, min = 10, max = 100, step = 5 },
